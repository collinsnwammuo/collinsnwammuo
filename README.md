<div align="center">
  ...
  <p>
    <a href="https://www.linkedin.com/in/collins-nwammuo/" target="_blank">
...
| **Networking & Security** | **Development & IoT** | **Tools & Platforms** |
| :--- | :--- | :--- |
| Network Segmentation (VLANs) | Python & Bash Scripting | Cisco Packet Tracer |
| SOC Fundamentals | Embedded C / Arduino | Wireshark & Tcpdump |
| Incident Detection | VANET Simulation (SUMO/NS3) | Elastic Stack (SIEM) |
| Log Analysis | HTML/CSS/JavaScript | Linux (Kali/Ubuntu) |
...
---
<div align="center">
  <sub>Last Updated: January 2026 • 📍 Nigeria (WAT)</sub>
</div>
